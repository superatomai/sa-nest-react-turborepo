  ...
  return (
    <>
      ...
      >
        ...
        <div className="space-y-2">
          ...
          <div className="space-y-2 text-xs text-gray-600">
            <div className="flex items-center gap-2">
              ...
              <span>
                ...
                {UICardDetails.createdAt
                  ? new Date(UICardDetails.createdAt).toLocaleDateString(
                      "en-US",
                      {
                        month: "short",
                        day: "numeric",
            ...
            <div className="flex items-center gap-2">
              ...
              <span>
                Updated{" "}
                {UICardDetails.updatedAt
                  ? getTimeAgo(UICardDetails.updatedAt)
                  : "N/A"}
              </span>
            </div>
          </div>
          ...
          <div className="w-full">
            <div
              className={`w-full py-1 px-3 rounded-lg text-center text-sm font-medium transition-colors ${
                UICardDetails.published
        ...
        {/* Hover actions */}
        <div className="w-full opacity-0 group-hover:opacity-100 focus:opacity-100 group-focus:opacity-100 transition-all duration-200 flex justify-between relative py-2">
          <button className="py-1 px-3 bg-white outline-1 rounded-md text-xs z-20 hover:bg-gray-50 transition-colors">
