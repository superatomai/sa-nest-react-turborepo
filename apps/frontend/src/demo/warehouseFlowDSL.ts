                        ...
                        "children": [
                          {
                            ...
                            "type": "tr",
                            "props": {
                              "className": "{{transaction.status === 'discrepancy' ? 'bg-red-50 hover:bg-red-100 border-l-4 border-red-500' : transaction.status === 'complete' ? 'hover:bg-gray-50' : 'hover:bg-gray-50'}}"
                            },
                            "children": [
                              {
                                "id": "td-type",
                                ...
                                "children": [
                                  {
                                    ...
                                    "type": "span",
                                    "props": {
                                      "className": "{{transaction.type === 'putaway' ? 'ds-badge ds-badge-success' : transaction.type === 'picking' ? 'ds-badge ds-badge-error' : 'ds-badge ds-badge-neutral'}}"
                                    },
                                    "children": ["{{transaction.type.charAt(0).toUpperCase() + transaction.type.slice(1)}} {{transaction.status === 'discrepancy' ? '⚠️' : transaction.status === 'complete' ? '✅' : ''}}"]
                                  }
                                ]
                              },
                              {
                                ...
                                "type": "td",
                                "props": {
                                  "className": "ds-table-cell ds-table-cell-mono {{transaction.status === 'discrepancy' ? 'ds-font-bold ds-text-error' : 'ds-text-primary'}}"
                                },
                                "children": ["{{transaction.taskId}}"]
                              },
                              {
                                "id": "td-quantity",
                                "type": "td",
                                "props": {
                                  "className": "ds-table-cell {{transaction.status === 'discrepancy' ? 'ds-font-bold ds-text-error' : 'ds-font-medium ds-text-primary'}}"
                                },
                                "children": ["{{transaction.type === 'putaway' || transaction.type === 'return' || transaction.type === 'adjustment' ? (transaction.quantity >= 0 ? '+' : '') : '-'}}{{Math.abs(transaction.quantity)}} units"]
                              },
                              {
                                "id": "td-description",
                                "type": "td",
                                ...
                                "children": [
                                  {
                                    ...
                                    "props": {
                                      ...
                                      "data-worker-id": "{{transaction.workerId}}",
                                      "data-worker-name": "{{transaction.workerName}}"
                                    },
                                    "children": ["{{transaction.workerId}}"]
                                  }
                                ]
                              },
                              {
                                ...
                                "children": [
                                  {
                                    ...
                                    "type": "span",
                                    "props": {
                                      "className": "{{transaction.status === 'discrepancy' ? 'ds-badge ds-badge-error' : transaction.status === 'complete' ? 'ds-badge ds-badge-success' : 'ds-badge ds-badge-neutral'}}"
                                    },
                                    "children": ["{{transaction.status === 'discrepancy' ? 'SCANNING ERROR' : transaction.status === 'complete' ? 'COMPLETED' : transaction.status.toUpperCase()}}"]
                                  }
                                ]
                              }
                            ]
                    ...
                    "children": [
                      {
                        ...
                        "type": "div",
                        "props": {
                          "className": "{{scanLog.isAnomaly ? 'flex items-center p-4 bg-red-50 border border-red-200 rounded-lg' : 'flex items-center p-4 bg-gray-50 border border-gray-200 rounded-lg'}}"
                        },
                        "children": [
                          {
                            "id": "scan-timestamp",
                            "type": "div",
                            "props": {
                              "className": "{{scanLog.isAnomaly ? 'w-24 text-sm font-mono text-red-600' : 'w-24 text-sm font-mono text-gray-600'}}"
                            },
                            "children": ["{{scanLog.timestamp}}"]
                          },
                          {
                            "id": "scan-details",
                            "type": "div",
                            ...
                            "children": [
                              {
                                ...
                                "type": "div",
                                "props": {
                                  "className": "{{scanLog.isAnomaly ? 'font-semibold text-red-800' : 'font-semibold text-gray-900'}}"
                                },
                                "children": ["{{scanLog.action}} - {{scanLog.quantity}} units {{scanLog.isAnomaly ? '(ANOMALY DETECTED)' : ''}}"]
                              },
                              {
                                "id": "scan-task-ref",
                                "type": "div",
                                ...
                                "children": ["Task: {{scanLog.taskId}} | Worker: {{scanLog.workerId}} | Scanner: {{scanLog.scannerId}}"]
                              }
                            ]
                          },
                          {
                            ...
                            "type": "span",
                            "props": {
                              "className": "{{scanLog.isAnomaly ? 'px-3 py-1 bg-red-100 text-red-800 rounded-full text-sm font-medium' : scanLog.status === 'verified' ? 'px-3 py-1 bg-green-100 text-green-800 rounded-full text-sm font-medium' : 'px-3 py-1 bg-gray-100 text-gray-800 rounded-full text-sm font-medium'}}"
                            },
                            "children": ["{{scanLog.isAnomaly ? 'ANOMALY' : scanLog.status.toUpperCase()}}"]
                          }
                        ]
                      }
                    ]
                        ...
                        "children": [
                          {
                            ...
                            "type": "div",
                            "props": {
                              "className": "{{event.isRelevant ? 'flex items-center p-3 bg-yellow-50 border border-yellow-200 rounded-lg' : 'flex items-center p-3 bg-gray-50 border border-gray-200 rounded-lg'}}"
                            },
                            "children": [
                              {
                                "id": "event-timestamp",
                                ...
                                "children": [
                                  {
                                    ...
                                    "type": "div",
                                    "props": {
                                      "className": "{{event.isRelevant ? 'font-medium text-yellow-800' : 'font-medium text-gray-900'}}"
                                    },
                              ...
                              },
                              {
                                ...
                                "type": "span",
                                "props": {
                                  "className": "{{event.isRelevant ? 'px-2 py-1 bg-yellow-100 text-yellow-800 rounded text-xs font-medium' : 'px-2 py-1 bg-gray-100 text-gray-600 rounded text-xs'}}"
                                },
                                "children": ["{{event.isRelevant ? 'RELEVANT' : 'normal'}}"]
                              }
                            ]
                          }
                        ]
                        ...
                        "children": [
                          {
                            ...
                            "type": "li",
                            "props": {
                              "className": "{{finding.severity === 'high' ? 'text-red-700' : finding.severity === 'medium' ? 'text-orange-700' : 'text-gray-700'}}"
                            },
                    ...
                    "children": [
                      {
                        ...
                        "type": "div",
                        "props": {
                          "className": "{{error.impact === 'high' ? 'flex justify-between items-center p-3 rounded-lg bg-red-50 border border-red-200' : error.impact === 'medium' ? 'flex justify-between items-center p-3 rounded-lg bg-orange-50 border border-orange-200' : 'flex justify-between items-center p-3 rounded-lg bg-yellow-50 border border-yellow-200'}}"
                        },
                        "children": [
                          {
                          ...
                          },
                          {
                            ...
                            "type": "span",
                            "props": {
                              "className": "{{error.impact === 'high' ? 'px-2 py-1 rounded text-xs font-medium bg-red-100 text-red-800' : error.impact === 'medium' ? 'px-2 py-1 rounded text-xs font-medium bg-orange-100 text-orange-800' : 'px-2 py-1 rounded text-xs font-medium bg-yellow-100 text-yellow-800'}}"
                            },
                            "children": ["{{error.impact.toUpperCase()}}"]
                          }
                        ]
                      }
                    ]
                      ...
                      },
                      {
                        ...
                        "children": [
                          ...
                          },
                          {
                            ...
                            "for": {
                              "in": "recount.result.recommendations",
                              "as": "recommendation"
                            },
                            "children": [
                              {
